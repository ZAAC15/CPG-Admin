...
<head>
  ...
  <title>Camine pal Gym — Foro</title>
...
<nav class="sidebar">
  ...
  <ul class="nav-menu">
    ...
    <li class="nav-item active"><a href="forum.jsp" class="nav-link">
...
<main class="main-content">
  ...
  <header class="topbar">
    ...
    <div class="topbar-right">
      <div class="search-box">
        ...
        <input type="text" id="search-input" placeholder="Buscar por título, autor..." class="search-input" oninput="filtrarTabla()"/>
      </div>
  ...
  <div class="filters-row">
    <button class="filter-btn active" onclick="setFiltro('todos', this)">
      Todos <span id="count-todos" class="count-badge">0</span>
    </button>
    <button class="filter-btn" onclick="setFiltro('activo', this)">
      Activos <span id="count-activos" class="count-badge">0</span>
    </button>
    <button class="filter-btn" onclick="setFiltro('oculto', this)">
      Ocultos <span id="count-ocultos" class="count-badge">0</span>
    </button>
  </div>
  ...
  <div class="users-table-wrap">
    <table class="users-table">
      ...
      <tbody id="tabla-body">
      <tr><td colspan="6" style="text-align:center;padding:32px;color:var(--text-muted)">Cargando posts...</td></tr>
      </tbody>
    </table>
    <div class="pag-row">
