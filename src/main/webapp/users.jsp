...
<head>
  ...
  <title>Camine pal Gym — Usuarios</title>
...
<nav class="sidebar">
  ...
  <ul class="nav-menu">
    ...
    <li class="nav-item active"><a href="users.jsp" class="nav-link">
...
<main class="main-content">
  ...
  <div class="filters-row">
    <button class="filter-btn active" onclick="setFiltro('todos', this)">Todos los usuarios</button>
    <button class="filter-btn" onclick="setFiltro('cliente', this)">Solo BÁSICO</button>
    <button class="filter-btn" onclick="setFiltro('administrador', this)">Solo ADMIN</button>
    <button class="filter-btn" onclick="setFiltro('pro', this)">Solo PRO</button>
  ...
  <div class="users-table-wrap">
    <table class="users-table">
      ...
      <tbody id="tabla-body">
      <tr><td colspan="5" style="text-align:center;padding:32px;color:var(--text-muted)">Cargando usuarios...</td></tr>
      </tbody>
    </table>
    <div class="pag-row">
...
<div class="modal-overlay" id="modal-overlay">
  <div class="modal">
    ...
    <div class="form-grid">
      <div class="field"><label>Nombre</label><input id="u-nombre" placeholder="Nombre"/></div>
      <div class="field"><label>Apellidos</label><input id="u-apellidos" placeholder="Apellidos"/></div>
      <div class="field full"><label>Usuario (username)</label><input id="u-usuario" placeholder="nombre_usuario"/></div>
      <div class="field full"><label>Correo electrónico</label><input id="u-correo" type="email" placeholder="correo@ejemplo.com"/></div>
      <div class="field full"><label>Celular</label><input id="u-celular" placeholder="+57 300 000 0000"/></div>
      <div class="field full" id="campo-password">
      ...
      <div class="field full">
        ...
        <div class="roles-selector">
          <button class="role-chip selected" onclick="seleccionarRol('cliente', this)">BÁSICO</button>
          <button class="role-chip" onclick="seleccionarRol('pro', this)">PRO</button>
          <button class="role-chip" onclick="seleccionarRol('administrador', this)">ADMIN</button>
        </div>
        <input type="hidden" id="u-rol" value="cliente"/>
      </div>
    </div>
